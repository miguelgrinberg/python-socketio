...
class TestAsyncClient(unittest.TestCase):
    ...
    def test_handle_connect_namespace(self):
        ...
        c._connect_event.set.assert_called_once_with()
        c._trigger_event.mock.assert_called_once_with("connect", namespace="/bar")
    ...
    def test_handle_disconnect(self):
        ...
        c._trigger_event.mock.assert_any_call("__disconnect_final", namespace="/")
    ...
    def test_handle_disconnect_namespace(self):
        ...
        c._trigger_event.mock.assert_any_call("__disconnect_final", namespace="/foo")
        assert c.namespaces == {"/bar": "2"}
        assert c.connected
        _run(c._handle_disconnect("/bar"))
        c._trigger_event.mock.assert_any_call("disconnect", namespace="/bar")
        c._trigger_event.mock.assert_any_call("__disconnect_final", namespace="/bar")
        assert c.namespaces == {}
        assert not c.connected
    ...
    def test_handle_disconnect_unknown_namespace(self):
        ...
        c._trigger_event.mock.assert_any_call("disconnect", namespace="/baz")
        c._trigger_event.mock.assert_any_call("__disconnect_final", namespace="/baz")
        assert c.namespaces == {"/foo": "1", "/bar": "2"}
        assert c.connected
    ...
    def test_handle_event(self):
        ...
        c._trigger_event.mock.assert_called_once_with("foo", "/", ("bar", "baz"))
    ...
    def test_handle_error(self):
        ...
        assert not c.connected
        c._connect_event.set.assert_called_once_with()
        c._trigger_event.mock.assert_called_once_with("connect_error", "/", "error")
    ...
    def test_handle_eio_message(self):
        ...
        _run(c._handle_eio_message(b"foo"))
        c._handle_ack.mock.assert_called_with("/foo", None, {"1": b"foo", "2": b"bar"})
    ...
    def test_eio_disconnect(self):
        ...
        c._trigger_event.mock.assert_called_once_with("disconnect", namespace="/")
        assert c.sid is None
        assert not c.connected
