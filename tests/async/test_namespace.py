...
class TestAsyncNamespace:
    ...
    async def test_event_not_found(self):
        ...
        ns = MyNamespace("/foo")
        ns._set_server(mock.MagicMock())
        await ns.trigger_event("another_custom_message", "sid", {"data": "data"})
        assert result == {}
    ...
    async def test_emit(self):
        ...
        await ns.emit("ev", data="data", to="room", skip_sid="skip", callback="cb")
    ...
    async def test_enter_room(self):
        ...
        ns.server.enter_room.assert_awaited_with("sid", "room", namespace="/foo")
        await ns.enter_room("sid", "room", namespace="/bar")
        ns.server.enter_room.assert_awaited_with("sid", "room", namespace="/bar")
    ...
    async def test_leave_room(self):
        ...
        ns.server.leave_room.assert_awaited_with("sid", "room", namespace="/foo")
        await ns.leave_room("sid", "room", namespace="/bar")
        ns.server.leave_room.assert_awaited_with("sid", "room", namespace="/bar")
    ...
    async def test_session(self):
        ...
        ns.server.save_session.assert_awaited_with("sid", {"a": "b"}, namespace="/foo")
        await ns.save_session("sid", {"a": "b"}, namespace="/bar")
        ns.server.save_session.assert_awaited_with("sid", {"a": "b"}, namespace="/bar")
        ns.session("sid")
    ...
    async def test_send_client(self):
        ...
        ns.client.send.assert_awaited_with("data", namespace="/foo", callback="cb")
        await ns.send(data="data", namespace="/bar", callback="cb")
        ns.client.send.assert_awaited_with("data", namespace="/bar", callback="cb")
