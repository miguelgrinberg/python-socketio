...
class TestAsyncServer(unittest.TestCase):
    ...
    def test_enter_room(self, eio):
        ...
        s.manager.enter_room.mock.assert_called_once_with("123", "/foo", "room")
    ...
    def test_leave_room(self, eio):
        ...
        s.manager.leave_room.mock.assert_called_once_with("123", "/foo", "room")
    ...
    def test_send_packet(self, eio):
        ...
        s.eio.send.mock.assert_called_once_with("123", '2/foo,["my event","my data"]')

    def test_send_eio_packet(self, eio):
        eio.return_value.send = AsyncMock()
        s = async_server.AsyncServer()
        _run(s._send_eio_packet("123", eio_packet.Packet(eio_packet.MESSAGE, "hello")))
    ...
    def test_handle_connect_rejected_with_exception(self, eio):
        ...
        assert not s.manager.is_connected("1", "/")
        handler.assert_called_once_with("1", "environ")
        s.eio.send.mock.assert_called_once_with("123", '4{"message":"fail_reason"}')
        assert s.environ == {"123": "environ"}
    ...
    def test_handle_disconnect(self, eio):
        ...
        s.manager.disconnect.mock.assert_called_once_with("1", "/", ignore_queue=True)
        assert s.environ == {}
    ...
    def test_handle_event(self, eio):
        ...
        catchall_handler.mock.assert_called_once_with("my message", sid, "a", "b", "c")
