...
class TestPubSubManager:
    def test_sentinel_url_parser(self):
        ...
        assert parse_redis_sentinel_url("redis+sentinel://localhost:6379") == (
            [("localhost", 6379)],
            None,
            {},
        )
        ...
        ) == ([("192.168.0.1", 6379), ("192.168.0.2", 6379)], None, {})
        assert parse_redis_sentinel_url("redis+sentinel://h1:6379,h2:6379/0") == (
            [("h1", 6379), ("h2", 6379)],
            None,
            {"db": 0},
        )
