...
class TestClient(unittest.TestCase):
    ...
    def test_handle_disconnect_namespace(self):
        ...
        c._trigger_event.assert_any_call("__disconnect_final", namespace="/foo")
        assert c.namespaces == {"/bar": "2"}
        assert c.connected
        c._handle_disconnect("/bar")
        c._trigger_event.assert_any_call("disconnect", namespace="/bar")
        c._trigger_event.assert_any_call("__disconnect_final", namespace="/bar")
        assert c.namespaces == {}
        assert not c.connected
    ...
    def test_handle_disconnect_unknown_namespace(self):
        ...
        c._trigger_event.assert_any_call("disconnect", namespace="/baz")
        c._trigger_event.assert_any_call("__disconnect_final", namespace="/baz")
        assert c.namespaces == {"/foo": "1", "/bar": "2"}
        assert c.connected
